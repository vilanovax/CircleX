...
export default function AddEventSheet({
  ...
  return (
    ...
    >
      ...
      <h2 id="add-event-title" className="font-bold text-lg mb-4 text-ink dark:text-zinc-100">
        ساخت رویداد جدید
      </h2>

      <label className="block text-sm font-medium mb-2 text-ink dark:text-zinc-200">نوع رویداد</label>
      ...
      <div className="flex gap-3 mb-4">
        <div className="flex-1">
          <label className="block text-sm font-medium mb-1 text-ink dark:text-zinc-200">تاریخ</label>
          <input
            type="date"
            value={date}
        ...
        <div className="w-24">
          <label className="block text-sm font-medium mb-1 text-ink dark:text-zinc-200">ساعت</label>
          <input
            value={time}
      ...
      <label className="block text-sm font-medium mb-1 text-ink dark:text-zinc-200">مکان</label>
      <input
        value={location}
      ...
      <label className="block text-sm font-medium mb-1 text-ink dark:text-zinc-200">ظرفیت (اختیاری)</label>
      <input
        value={capacity}
