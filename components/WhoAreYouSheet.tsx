    ...
    >
      <form id="who-are-you-form" onSubmit={onSubmit} className="pt-2 pb-1">
        <h2
          ...
          className="text-[20px] font-extrabold text-ink dark:text-zinc-50 leading-snug tracking-tight"
        >
          خودت را معرفی کن
        </h2>
        ...
        <input
          ...
          name="given-name"
          disabled={busy}
          className="field text-start text-[15px] min-h-12 font-semibold"
          aria-invalid={!!error}
        ...
        <div className="mt-6">
          <div className="flex items-center gap-3">
            <span className="relative w-11 h-11 shrink-0 rounded-full overflow-hidden ring-1 ring-black/10 dark:ring-white/10 bg-zinc-100 dark:bg-zinc-800">
            ...
            <button
              ...
              className="text-start text-[13px] font-semibold text-brand-700 dark:text-brand-300 min-h-11"
            >
              {pickAvatar ? "بستن تصاویر" : "تغییر تصویر"}
            </button>
          </div>
          {pickAvatar ? (
            <div
              ...
              className="grid grid-cols-5 gap-2.5 mt-3"
            >
